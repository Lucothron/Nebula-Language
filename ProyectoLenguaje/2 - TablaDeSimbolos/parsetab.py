...
_lr_productions = [
  ...
  ('S -> FOR LPAREN RELEXPR RPAREN S END S','S',7,'p_S_FOR','nebulaSyn.py',90),
  ('S -> O','S',1,'p_S_OPERATION','nebulaSyn.py',95),
  ...
  ('VECDEF -> VEC LBRACK RBRACK','VECDEF',3,'p_VECDEF','nebulaSyn.py',131),
  ('MATDEF -> MAT LBRACK RBRACK','MATDEF',3,'p_MATDEF','nebulaSyn.py',136),
  ('VECTOR -> LBRACK NUMTYPE RBRACK','VECTOR',3,'p_VECTOR','nebulaSyn.py',141),
  ('MATRIX -> LBRACK NUMTYPE COMMA NUMTYPE RBRACK','MATRIX',5,'p_MATRIX','nebulaSyn.py',146),
  ...
  ('O -> O EQUAL O','O',3,'p_O_EQUAL','nebulaSyn.py',161),
  ('O -> O PLUS TIER1','O',3,'p_O_MATHTIER1','nebulaSyn.py',166),
  ('O -> O MINUS TIER1','O',3,'p_O_MATHTIER1','nebulaSyn.py',167),
  ('TIER1 -> TIER1 MULT TIER2','TIER1',3,'p_O_MATHTIER2','nebulaSyn.py',172),
  ('TIER1 -> TIER1 DIV TIER2','TIER1',3,'p_O_MATHTIER2','nebulaSyn.py',173),
  ('TIER2 -> LPAREN O RPAREN','TIER2',3,'p_O_MATHTIER3','nebulaSyn.py',178),
  ('O -> TIER1','O',1,'p_O_T1','nebulaSyn.py',183),
  ('TIER1 -> TIER2','TIER1',1,'p_O_T2','nebulaSyn.py',188),
  ('TIER2 -> VAR','TIER2',1,'p_O_T3','nebulaSyn.py',193),
  ('EMPTY -> <empty>','EMPTY',0,'p_EMPTY','nebulaSyn.py',198),
]
